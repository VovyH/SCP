...
import numpy as np  # 添加这一行以导入numpy
...
PAP_origin_Input_path = r"E:/code/Chemotherapy/data/common_input.csv"
...
def main():
    ...
    plt.xticks(
        range(1, len(origin_input_scores) + 1, 1),
        range(1, len(origin_input_scores) + 1, 1),
    )
